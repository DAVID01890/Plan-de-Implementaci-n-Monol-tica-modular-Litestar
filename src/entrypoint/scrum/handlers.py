...
@delete("/proyectos/{proyecto_id:str}", status_code=200)
...
@post("/proyectos/{proyecto_id:str}/historias")
async def add_historia(
    ...
    await proyecto_repo.save(proyecto)
    result = _proyecto_to_response(proyecto)
    return result


@post("/proyectos/{proyecto_id:str}/sprints")
...
@post("/proyectos/{proyecto_id:str}/sprints/historias")
...
@post("/proyectos/{proyecto_id:str}/sprints/{sprint_id:str}/start")
